  ...
  return (
    <div className="header">
      <div className="container container__header">
        ...
        {/* Поиск рендерится только на главной странице, есть все пиццы */}
        {pathname === '/' ? <Search /> : null}

        {/* Кнопка корзины не рендерится только в самой корзине, в других роутах они есть */}
        {pathname.indexOf('/cart') ? (
